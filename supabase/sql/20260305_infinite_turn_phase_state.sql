-- RugbyTCG2026 infinite-turn hotfix:
-- 1) keep matches.turn_owner synced from authoritative phase_state payload
-- 2) ignore stale phase_state snapshots by source_seq
-- 3) do not derive turn_started_at from phase_state timer payload
